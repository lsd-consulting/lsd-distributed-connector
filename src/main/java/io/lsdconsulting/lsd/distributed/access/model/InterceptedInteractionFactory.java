...
public class InterceptedInteractionFactory {
    ...
    public InterceptedInteraction buildFrom(final String body, final String traceId,
                                            ...
                                            final String target, final String path, final InteractionType interactionType) {

        return buildFrom(body, headers, traceId, serviceName, target, path, null, null, interactionType);
    }
    ...
    public InterceptedInteraction buildFrom(final String body, final Map<String, Collection<String>> requestHeaders, final String traceId,
                                            ...
                                            final String httpMethod, final InteractionType interactionType) {

        return buildFrom(body, requestHeaders, emptyMap(), traceId, serviceName, target, path, httpStatus, null, httpMethod, interactionType);
    }
